...
<div class="container">
    ...
    {!! Form::model($outdated, ['route' => ['categories.update', $outdated], 'method' => 'put','files'=>true, 'class'=>'formulario row g-3']) !!}
   
    <div class="col-md-6">
        <label for="name" class="form-label">Producto</label>
        {!! Form::select('suplier_id', $products, null, ['class' => 'form-control  block w-full mt-1','style'=>'color:white', 'placeholder'=>'Seleccione Un Proveedor .....']) !!}                   
        @error('product_id')
