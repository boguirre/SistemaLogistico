        ...
        <div>
            <table id="datos">
                ...
                <tbody>
                    <tr>
                        <th>
                            <p id="proveedor">Nombre: {{$purchase->supliers->name}}<br>
                                {{--  {{$purchase->provider->document_type}}-COMPRA: {{$purchase->provider->document_number}}<br>  --}}
                                Dirección: {{$purchase->supliers->address}}<br>
                                Teléfono: {{$purchase->supliers->phone}}<br>
                                Email: {{$purchase->supliers->email}}</p>
                        </th>
                    </tr>
                </tbody>
            </table>
