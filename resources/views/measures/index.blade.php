...
<div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        ...
                        <a href="{{url('/measures/create')}}" class="btn btn-xm btn-primary"  style="float: right;">Crear Unidad de medida</a>
                          {{-- </div> --}}
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex">                                                        
                                                    ...
                                                    <p class="align-self-center mb-0 admin-name"> {{$measure->id}} </p>
                                                </div>
                                            </td>
                                            <td>{{$measure->name}}</td>
