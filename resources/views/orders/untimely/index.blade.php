    ...
    <div class="page-meta">
        ...
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Pedidos Entregados Con Destiempo</li>
            </ol>
        </nav>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @break
                                @case('DESTIEMPO')
                                <span class="display badge badge-light-danger inv-status">DESTIEMPO</span>
                            ...
                            <td class="text-center">
                                <ul class="table-controls">
                                        ...
                                        <a href="{{route('orders.show',$order)}}" class="bs-tooltip text-center" style="display: block"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Ver"
                                            data-original-title="Ver"> Ver
