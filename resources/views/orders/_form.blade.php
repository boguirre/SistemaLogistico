...
<div class="row">
    <div class="col-md-3">
        ...
        {!! Form::select('category_id', $category, null, [
            ...
            'style' => 'background:#1b2e4b;width: 100%',
            'id' => 'country',
    ...
    <div class="col-md-3">
        ...
        <select class="form-control" name="product_id" id="product_id">
            ...
            @foreach ($products as $product)
                <option value="{{ $product->id }}_{{ $product->stock }}_{{ $product->price }}">{{ $product->name }}
                </option>
            @endforeach
        </select>
        @error('product_id')
        ...
        <table id="detalles" class="table">
            ...
            <tfoot>
                <tr>
                    ...
                    <th>
                        <p align="right"><span id="total_html">0.00</span> <input type="hidden" name="total"
                                id="total_value"></p>
                    </th>
                </tr>
            </tfoot>
